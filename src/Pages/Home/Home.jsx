            ...
            <section className={`${styles.content} h-100`}>
				...
				<div className="container m-auto">
					<div className="row row-cols-sm-1 row-cols-md-2 pt-3">
						<div className="col-8 col-sm-9 col-md-5 col-lg-5 col-xl-5 m-auto py-5">
							<img
								src={profile}
								alt="profile"
								id="profile-image"
								className="w-75 float-end mt-0 py-5 rounded-circle"
							/>
						</div>
						<div
							className="
						...
						>
							...
							<Link
								to="/contact_us"
								className="btn text-white px-4 mt-2 rounded-pill touch"
